...
// MongoDB कनेक्शन
mongoose.connect("mongodb://127.0.0.1:27017/reelindia", {
...
// ✅ Fixed: transporter variable name
const transporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: "rankishank@gmail.com",
    pass: "zvsegtmabmhsuegp",
  },
});
let otpStore = {};
// ✅ Auth middleware पहले define करें
...
// ✅ All reels (सबसे जरूरी - Feed page के लिए)
...
// ✅ NEW: Get Chat Users (Following/Followers)
